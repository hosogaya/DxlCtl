...
public:
	...
	uint32_t getByteData(uint8_t id, uint16_t startbyte,uint16_t read_byte){
		switch (read_byte) {
            case 1: return data_list_[id][startbyte];
            case 2: return DXL_MAKEWORD(data_list_[id][startbyte], data_list_[id][startbyte+1]);
            case 4: return DXL_MAKEDWORD(DXL_MAKEWORD(data_list_[id][startbyte], data_list_[id][startbyte+1]), DXL_MAKEWORD(data_list_[id][startbyte+2], data_list_[id][startbyte+3]));  
            default: return 0;
        }
    }
